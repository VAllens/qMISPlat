...
namespace CPFrameWork.Utility.DbOper
{
    ...
    public class CPPagedResult<T> : IEnumerable<T>, ICollection<T>
    {
        #region Public Fields
        /// <summary>
        /// 获取一个当前类型的空值。
        /// </summary>
        public static readonly CPPagedResult<T> Empty = new CPPagedResult<T>(0, 0, 0, 0, null);
        #endregion
        ...
        public CPPagedResult(int totalRecords, int totalPages, int pageSize, int pageNumber, List<T> data)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj == (object)null)
                return false;
            var other = obj as CPPagedResult<T>;
        ...
        public static bool operator ==(CPPagedResult<T> a, CPPagedResult<T> b)
        {
